                    ...
                    <div class="inner">
                        ...
                        <div class="row gtr-200">
                            <div class="col-6 col-12-medium ">
                                ...
                                <ul class="actions">
                                        <li><a href="{$conf->app_url}/app/chroniona.php" class="button primary">Kolejna chroniona strona</a></li>
                                        <li><a href="{$conf->app_url}/app/security/logout.php" class="button">Wyloguj</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
