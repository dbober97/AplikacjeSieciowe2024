...
<nav id="nav">
                <ul class="links">
                    ...
                    <li class="active"><a href="{$conf->action_url}kontakt">Kontakt</a></li>
                    {if \core\RoleUtils::inRole("admin") || \core\RoleUtils::inRole("moderator") || \core\RoleUtils::inRole("czytelnik") || \core\RoleUtils::inRole("autor")}
                        ...
                        <ol>
                           <li><a class="dropdown-toggle" data-toggle="dropdown" >Panel zalogowanego: {\core\SessionUtils::load("login", true)}</a>
                                <ul>
                                  <li><a {if \core\RoleUtils::inRole("admin")}href="{$conf->action_url}panelAdmin"{/if}>administrator</a></li>
                                  <li><a {if \core\RoleUtils::inRole("moderator")}href="{$conf->action_url}panelModerator"{/if}>moderator</a></li>
                                  <li><a {if \core\RoleUtils::inRole("autor")}href="{$conf->action_url}panelAutor"{/if}>autor</a></li>
                                   <li><a {if \core\RoleUtils::inRole("czytelnik")}href="{$conf->action_url}panelCzytelnik"{/if}>czytelnik</a></li>
                                </ul>
                           </li>
                       </ol> 
                        {else}
